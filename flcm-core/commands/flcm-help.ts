...
export class HelpCommand {
   ...
   */
  private initializeCommands(): Map<string, CommandInfo> {
   ...
   */
  private showAllCommands(verbose: boolean): void {
    console.log('\n' + '='.repeat(60));
...
export default async function help(options: HelpOptions = {}): Promise<void> {
