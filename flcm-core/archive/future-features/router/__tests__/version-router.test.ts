...
import { VersionRouter, VersionRequest, VersionResponse, VersionHandler } from '../index';
import { VersionDetector } from '../version-detector';

// Mock handlers
class MockV1Handler implements VersionHandler {
...
class MockV2Handler implements VersionHandler {
  async handle(request: VersionRequest): Promise<VersionResponse> {
    return {
      status: 200,
