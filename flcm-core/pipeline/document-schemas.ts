 ...
 */
export function isContentBrief(doc: BaseDocument): doc is ContentBrief {
  return doc.type === DocumentType.CONTENT_BRIEF;
}

export function isKnowledgeSynthesis(doc: BaseDocument): doc is KnowledgeSynthesis {
  return doc.type === DocumentType.KNOWLEDGE_SYNTHESIS;
}

export function isContentDraft(doc: BaseDocument): doc is ContentDraft {
  return doc.type === DocumentType.CONTENT_DRAFT;
}

export function isPlatformAdaptation(doc: BaseDocument): doc is PlatformAdaptation {
