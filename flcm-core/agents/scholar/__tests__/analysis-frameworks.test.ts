...
describe('Analysis Frameworks', () => {
  ...
  describe('SWOT-USED Framework', () => {
    let framework: SWOTUSEDFramework;

    beforeEach(() => {
      framework = new SWOTUSEDFramework();
    });
    ...
    it('should identify relevant weaknesses', async () => {
      ...
      expect(result.weaknesses.some(w => 
        w.toLowerCase().includes('investment') || 
        w.toLowerCase().includes('training') || 
        w.toLowerCase().includes('complexity')
      )).toBe(true);
    });
    ...
    it('should identify opportunities', async () => {
      ...
      expect(result.opportunities.some(o => 
        o.toLowerCase().includes('competitive') || 
        o.toLowerCase().includes('advantage') || 
        o.toLowerCase().includes('innovation')
      )).toBe(true);
    });
    ...
    it('should identify threats', async () => {
      ...
      expect(result.threats.some(t => 
        t.toLowerCase().includes('displacement') || 
  ...
  describe('SCAMPER Framework', () => {
    let framework: SCAMPERFramework;

    beforeEach(() => {
      framework = new SCAMPERFramework();
    });
    ...
    it('should identify substitution opportunities', async () => {
      ...
      expect(result.substitute.some(s => 
    ...
    it('should identify combination possibilities', async () => {
      ...
      expect(result.combine.some(c => 
        c.toLowerCase().includes('integrate') || 
        c.toLowerCase().includes('merge') || 
        c.toLowerCase().includes('combine')
      )).toBe(true);
    });
    ...
    it('should suggest adaptations', async () => {
      ...
      expect(result.adapt.some(a => 
        a.toLowerCase().includes('adapt') || 
        a.toLowerCase().includes('adjust') || 
        a.toLowerCase().includes('modify')
      )).toBe(true);
    });
    ...
    it('should identify modification opportunities', async () => {
      ...
      expect(result.modify.some(m => 
        m.toLowerCase().includes('enhance') || 
        m.toLowerCase().includes('improve') || 
        m.toLowerCase().includes('change')
      )).toBe(true);
    });
    ...
    it('should identify elimination candidates', async () => {
      ...
      expect(result.eliminate.some(e => 
        e.toLowerCase().includes('remove') || 
        e.toLowerCase().includes('eliminate') || 
        e.toLowerCase().includes('reduce')
      )).toBe(true);
    });
    ...
    it('should extract creative insights', async () => {
      ...
      expect(insights.some(insight => 
        insight.toLowerCase().includes('creative') || 
        insight.toLowerCase().includes('innovative') || 
        insight.toLowerCase().includes('new')
      )).toBe(true);
    });
  });

  describe('Socratic Framework', () => {
    let framework: SocraticFramework;

    beforeEach(() => {
      framework = new SocraticFramework();
    });
    ...
    it('should identify underlying assumptions', async () => {
      ...
      expect(result.assumptions.some(a => 
        a.toLowerCase().includes('assume') || 
        a.toLowerCase().includes('presume') || 
        a.toLowerCase().includes('belief')
      )).toBe(true);
    });
    ...
    it('should explore implications', async () => {
      ...
      expect(result.implications.some(i => 
        i.toLowerCase().includes('implication') || 
        i.toLowerCase().includes('consequence') || 
        i.toLowerCase().includes('result')
      )).toBe(true);
    });
    ...
    it('should consider different perspectives', async () => {
      ...
      expect(result.perspectives.some(p => 
        p.toLowerCase().includes('perspective') || 
        p.toLowerCase().includes('viewpoint') || 
        p.toLowerCase().includes('stakeholder')
      )).toBe(true);
    });
    ...
    it('should extract philosophical insights', async () => {
      ...
      expect(insights.length).toBeGreaterThan(0);
      expect(insights.some(insight => 
        insight.toLowerCase().includes('question') || 
  ...
  describe('5W2H Framework', () => {
    let framework: FiveW2HFramework;

    beforeEach(() => {
      framework = new FiveW2HFramework();
    });
    ...
    it('should identify WHO stakeholders', async () => {
      ...
      expect(result.who.toLowerCase()).toMatch(
        /companies|employees|managers|organizations|stakeholders/
      );
    });
    ...
    it('should identify WHAT is happening', async () => {
      ...
      expect(result.what.toLowerCase()).toMatch(
        /artificial intelligence|ai|automation|implementation|integration/
      );
    });
    ...
    it('should identify WHEN timing', async () => {
      ...
      expect(result.when.toLowerCase()).toMatch(
        /current|emerging|now|implementation|adoption/
      );
    });
    ...
    it('should identify WHERE context', async () => {
      ...
      expect(result.where.toLowerCase()).toMatch(
        /business|operations|organizations|workplace|companies/
      );
    });
    ...
    it('should identify WHY reasons', async () => {
      ...
      expect(result.why.toLowerCase()).toMatch(
        /automate|improve|insights|competitive|advantage/
      );
    });
    ...
    it('should identify HOW methods', async () => {
      ...
      expect(result.how.toLowerCase()).toMatch(
        /implementation|integration|training|strategy|management/
      );
    });
    ...
    it('should identify HOW MUCH resources', async () => {
      ...
      expect(result.howMuch.toLowerCase()).toMatch(
        /investment|cost|resources|significant|training/
      );
    });
    ...
    it('should extract comprehensive insights', async () => {
      ...
      expect(insights.length).toBeGreaterThan(0);
      expect(insights.some(insight => 
        insight.toLowerCase().includes('comprehensive') || 
        insight.toLowerCase().includes('complete') || 
        insight.toLowerCase().includes('thorough')
      )).toBe(true);
    });
  });

  describe('Pyramid Framework', () => {
    let framework: PyramidFramework;

    beforeEach(() => {
      framework = new PyramidFramework();
    });
    ...
    it('should identify main conclusion', async () => {
      ...
      expect(result.conclusion.toLowerCase()).toMatch(
        /ai|artificial intelligence|transformation|implementation|success/
      );
    });
    ...
    it('should identify key arguments', async () => {
      ...
      expect(result.keyArguments.some(arg => 
        arg.toLowerCase().includes('opportunities') || 
        arg.toLowerCase().includes('challenges') || 
        arg.toLowerCase().includes('benefits')
      )).toBe(true);
    });
    ...
    it('should identify supporting data', async () => {
      ...
      expect(result.supportingData.some(data => 
        data.toLowerCase().includes('automate') || 
        data.toLowerCase().includes('decision-making') || 
        data.toLowerCase().includes('investment')
      )).toBe(true);
    });
    ...
    it('should provide context', async () => {
      ...
      expect(result.context.toLowerCase()).toMatch(
        /business|competitive|landscape|industry|market/
      );
    });
    ...
    it('should extract structured insights', async () => {
      ...
      expect(insights.length).toBeGreaterThan(0);
      expect(insights.some(insight => 
        insight.toLowerCase().includes('structured') || 
        insight.toLowerCase().includes('logical') || 
        insight.toLowerCase().includes('hierarchy')
      )).toBe(true);
    });
  });
  ...
  describe('Framework Performance and Integration', () => {
    it('should complete analysis within reasonable time', async () => {
      const frameworks = [
        new SWOTUSEDFramework(),
        new SCAMPERFramework(),
        new SocraticFramework(),
        new FiveW2HFramework(),
        new PyramidFramework(),
      ];
    ...
    it('should maintain consistent insight quality', async () => {
      ...
      for (const framework of frameworks) {
        ...
        expect(insights.every(insight => 
          typeof insight === 'string' && insight.length > 5
        )).toBe(true);
    ...
    it('should handle multilingual content gracefully', async () => {
      ...
      const framework = new SWOTUSEDFramework();
    ...
    it('should handle technical content appropriately', async () => {
      ...
      const framework = new PyramidFramework();
