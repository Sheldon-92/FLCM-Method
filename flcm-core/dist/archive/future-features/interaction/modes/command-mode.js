...
exports.CommandMode = void 0;
const logger_1 = require("../../shared/utils/logger");
class CommandMode {
    constructor(context) {
        this.deprecationWarnings = true;
        this.context = context;
        this.logger = new logger_1.Logger('CommandMode');
     ...
     * Execute command
     */
    async executeCommand(command, mapping, args) {
     ...
     */
    async executeLegacyCommand(handler, args) {
        // Parse handler path
...
Note: This command is deprecated and will be removed in FLCM 3.0.`;
     ...
     */
    formatDeprecationWarning(command, mapping) {
...
exports.CommandMode = CommandMode;
