...
export type TestRunnerType = 'jest' | 'mocha' | 'jasmine' | 'vitest' | 'ava' | 'tap' | 'cypress' | 'playwright' | 'webdriver' | 'cucumber' | 'storybook' | 'custom';
...
export type TestRunnerStatus = 'idle' | 'initializing' | 'running' | 'paused' | 'stopping' | 'stopped' | 'error' | 'maintenance';
...
export type TestSuiteType = 'unit' | 'integration' | 'e2e' | 'api' | 'ui' | 'performance' | 'security' | 'accessibility' | 'visual' | 'smoke' | 'regression' | 'acceptance';
export type TestCategory = 'functional' | 'non-functional' | 'structural' | 'change-related' | 'experience-based';
...
export type TestSuiteStatus = 'created' | 'ready' | 'running' | 'passed' | 'failed' | 'skipped' | 'error' | 'timeout';
...
export type TestCaseType = 'positive' | 'negative' | 'boundary' | 'equivalence' | 'decision-table' | 'state-transition' | 'use-case' | 'exploratory';
...
export type AssertionType = 'equality' | 'inequality' | 'comparison' | 'type' | 'structure' | 'regex' | 'custom';
export type AssertionOperator = 'equals' | 'not-equals' | 'deep-equals' | 'strict-equals' | 'greater-than' | 'less-than' | 'greater-equal' | 'less-equal' | 'contains' | 'not-contains' | 'matches' | 'not-matches' | 'throws' | 'not-throws' | 'resolves' | 'rejects';
...
export type TestCaseStatus = 'created' | 'ready' | 'running' | 'passed' | 'failed' | 'skipped' | 'error' | 'timeout' | 'quarantined';
...
export type EnvironmentType = 'local' | 'development' | 'testing' | 'staging' | 'production' | 'docker' | 'kubernetes' | 'cloud';
...
export type EnvironmentStatus = 'initializing' | 'ready' | 'degraded' | 'down' | 'maintenance' | 'error';
...
export type TestRunType = 'full' | 'incremental' | 'smoke' | 'regression' | 'performance' | 'security' | 'custom';
...
export type TestTrigger = 'manual' | 'scheduled' | 'webhook' | 'git-commit' | 'git-pr' | 'deployment' | 'api' | 'monitoring';
...
export type TestRunStatus = 'created' | 'queued' | 'running' | 'paused' | 'completed' | 'failed' | 'cancelled' | 'timeout' | 'error';
export type TestRunPhase = 'initializing' | 'setup' | 'execution' | 'teardown' | 'reporting' | 'cleanup' | 'completed';
...
export type TestFrameworkPhase = 'initializing' | 'ready' | 'running' | 'paused' | 'maintenance' | 'shutdown' | 'error';
...
export type ReporterType = 'console' | 'html' | 'json' | 'xml' | 'junit' | 'allure' | 'mochawesome' | 'tap' | 'spec' | 'dot' | 'nyan' | 'custom';
...
export type PluginType = 'runner' | 'reporter' | 'transformer' | 'matcher' | 'mock' | 'fixture' | 'environment' | 'coverage' | 'performance' | 'security' | 'accessibility' | 'integration' | 'utility';
...
export type FixtureType = 'data' | 'mock' | 'service' | 'environment' | 'database' | 'file' | 'network' | 'user' | 'permission' | 'configuration';
