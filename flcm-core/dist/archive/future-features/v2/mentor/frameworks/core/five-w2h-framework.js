...
class FiveW2HFramework extends base_1.BaseFramework {
    constructor() {
        super();
...
This systematic approach ensures no critical aspect is overlooked.`;
    ...
    getQuestions(context) {
        ...
        return [
            ...
            {
                id: 'when_duration',
                question: 'WHEN does it start and end? What', s, the, expected, duration, ',: type, 'open': ,
                required: false
            },
            // WHERE
            {
    ...
    identifyRisks(analysis, answers) {
        const risks = [];
        // Timeline risks
    ...
    generateExecutiveSummary(analysis, answers) {
...
//# sourceMappingURL=five-w2h-framework.js.map