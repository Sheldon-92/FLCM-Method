...
exports.TeachingPreparationFramework = void 0;
const base_1 = require("../base");
class TeachingPreparationFramework extends base_1.ProgressiveFramework {
    constructor() {
        super();
...
[Beginner/Intermediate/Advanced/Expert]`;
    ...
    calculateUnderstandingLevel(answers) {
        let score = 0;
        let factors = 0;
    ...
    getFeynmanLevel(understanding) {
        if (understanding < 0.3)
            return 'Surface - Can recite facts';
        if (understanding < 0.5)
            return 'Shallow - Understands basics';
        if (understanding < 0.7)
            return 'Developing - Can explain simply';
        if (understanding < 0.9)
            return 'Deep - Can teach effectively';
...
exports.TeachingPreparationFramework = TeachingPreparationFramework;
//# sourceMappingURL=teaching-prep-framework.js.map