...
exports.ConnectionAnalyzer = void 0;
const logger_1 = require("../shared/utils/logger");
class ConnectionAnalyzer {
    constructor() {
        this.logger = new logger_1.Logger('ConnectionAnalyzer');
     ...
     */
    async calculateConnectionWeight(node1, node2) {
        const weights = {
        ...
        const totalWeight = (weights.explicit * 0.35 + // Direct links are strong indicators
     ...
     */
    calculateExplicitLinkWeight(node1, node2) {
     ...
     */
    calculateTFIDFSimilarity(keywords1, keywords2) {
     ...
     */
    calculateTF(keywords, vocabulary) {
    ...
    calculateTemporalProximity(node1, node2) {
        const timeDiff = Math.abs(node1.metadata.created.getTime() - node2.metadata.created.getTime());
        // Convert to hours
     ...
     */
    calculateFrameworkAlignment(node1, node2) {
     ...
     */
    getFrameworkSimilarity(framework1, framework2) {
     ...
     */
    calculateCoOccurrence(node1, node2) {
     ...
     */
    calculateImportanceWeight(node1, node2) {
     ...
     */
    analyzeConnectionTypes(node1, node2) {
        const types = [];
     ...
     */
    getConnectionMetadata(node1, node2) {
        return {
...
exports.ConnectionAnalyzer = ConnectionAnalyzer;
//# sourceMappingURL=connection-analyzer.js.map