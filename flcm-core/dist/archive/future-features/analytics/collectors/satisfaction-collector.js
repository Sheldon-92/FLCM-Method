...
exports.SatisfactionCollector = void 0;
...
class SatisfactionCollector {
    constructor() {
        ...
        this.logger = new logger_1.Logger('SatisfactionCollector');
     ...
     */
    collectFeedback(version, userId, feedback) {
        const feedbackEntry = {
            userId,
            version,
     ...
     */
    getFeedbackSummary(version, limit = 5) {
        const feedback = this.feedback.get(version) || [];
        return feedback
            .filter(f => f.text)
            .slice(-limit)
...
exports.SatisfactionCollector = SatisfactionCollector;
//# sourceMappingURL=satisfaction-collector.js.map