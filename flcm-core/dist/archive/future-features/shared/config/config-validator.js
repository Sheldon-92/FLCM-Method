...
exports.validateConfig = exports.ConfigValidator = exports.ValidationSeverity = void 0;
...
class ConfigValidator {
     ...
     */
    addIssue(path, message, severity, rule) {
        this.issues.push({
            path,
            message,
            severity,
