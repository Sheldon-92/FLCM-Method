...
exports.FrontmatterManager = void 0;
...
class FrontmatterManager {
    ...
    parseFlcmYaml(yamlData) {
        ...
        metadata.session_id = extractField('session_id') || (0, uuid_1.v4)();
        ...
        if (syncMatch) {
            ...
            metadata.sync = {
                ...
                sync_source: this.extractString(syncData, 'sync_source') || 'obsidian',
     ...
     */
    extractString(yamlSection, field) {
     ...
     */
    extractNumber(yamlSection, field) {
     ...
     */
    updateExistingFrontmatter(frontmatter, metadata) {
...
---`;
     ...
     */
    serializeFlcmMetadata(metadata) {
        const lines = [];
        // Basic fields
...
`;
     ...
     */
    async updateForSync(content, syncSource, modifiedTime) {
...
exports.FrontmatterManager = FrontmatterManager;
//# sourceMappingURL=frontmatter-manager.js.map