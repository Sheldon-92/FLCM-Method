...
const voice_dna_1 = require("../voice-dna");
describe('VoiceDNAAnalyzer', () => {
    let voiceDNA;
    let sampleText;
    beforeEach(() => {
        voiceDNA = new voice_dna_1.VoiceDNAAnalyzer();
        sampleText = `
    ...
    describe('Constructor', () => {
        test('should initialize properly', () => {
            ...
            expect(voiceDNA).toBeInstanceOf(voice_dna_1.VoiceDNAAnalyzer);
        });
    });
    ...
    describe('Edge Cases and Error Handling', () => {
        ...
        test('should handle malformed input gracefully', async () => {
            ...
            for (const input of malformedInputs) {
                const analysis = await voiceDNA.analyzeVoice(input);
                expect(analysis).toBeDefined();
                expect(analysis.confidence).toBe(0);
            }
        });
...
//# sourceMappingURL=voice-dna.test.js.map