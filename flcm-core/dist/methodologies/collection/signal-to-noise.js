...
exports.SignalToNoiseFilter = void 0;
/**
 * Signal-to-Noise Filter Class
 */
class SignalToNoiseFilter {
    constructor() {
        this.noisePatterns = [
            // Filler phrases
     ...
     */
    extractContext(sentence, content) {
     ...
     */
    generateSummary(signals, noiseLevel, ratio) {
     ...
     */
    getCleanContent(content, analysis) {
...
exports.SignalToNoiseFilter = SignalToNoiseFilter;
exports.default = SignalToNoiseFilter;
//# sourceMappingURL=signal-to-noise.js.map