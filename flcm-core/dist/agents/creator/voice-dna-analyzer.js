...
const logger = (0, logger_1.createLogger)('VoiceDNAAnalyzer');
class VoiceDNAAnalyzer {
    ...
    calculateVocabularyRichness(samples) {
        const allWords = [];
        for (const sample of samples) {
...
//# sourceMappingURL=voice-dna-analyzer.js.map